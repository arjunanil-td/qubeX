...
from ..io.theme import THEME_STYLESHEET
from ..io.ui_banner import Banner
...
class RenameToolUI(QtWidgets.QDialog):
    def __init__(self, parent=maya_main_window()):
        ...
        self.setWindowTitle("QubeX Rename Tool")
    ...
    def build_ui(self):
        ...
        banner = Banner("QubeX Rename Tool", "rename.png")
        ...
        btn_ns.clicked.connect(cleanup_utils.cleanup_namespaces)
    ...
    def run_apply_affix(self, mode):
        ...
        name_utils.apply_affix(items, affix, mode)
        self.populate_object_list()
    ...
    def run_search_replace(self):
        ...
        name_utils.search_replace(items, search_text, replace_text)
        self.populate_object_list()
    
    def run_change_case(self, method):
        items = self.get_selected_objects()
        name_utils.change_case(items, method)
        self.populate_object_list()

    def run_fix_duplicates(self):
        name_utils.fix_duplicates()
        self.populate_object_list()

    def run_fix_shape_names(self):
        name_utils.fix_shape_names()
        self.populate_object_list()
